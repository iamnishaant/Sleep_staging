...
| B. Reference model | Gemini 3.8 Flash under P1, on each training packet | About a month at the free tier's current ~4 successful responses a day (19 of 87 attempts succeed) | Only after verification; failures would need handling |
